...
const carta4 = document.querySelector('.carta-1-5');
const carta5 = document.querySelector('.carta-1-6');
const carta6 = document.querySelector('.carta-2-1');
const carta7 = document.querySelector('.carta-2-2');
const carta8 = document.querySelector('.carta-2-3');
const carta9 = document.querySelector('.carta-2-4');
const carta10 = document.querySelector('.carta-2-5');
const carta11 = document.querySelector('.carta-2-6');
const carta12 = document.querySelector('.carta-3-1');
const carta13 = document.querySelector('.carta-3-2');
const carta14 = document.querySelector('.carta-3-3');
const carta15 = document.querySelector('.carta-3-4');
const carta16 = document.querySelector('.carta-3-5');
const carta17 = document.querySelector('.carta-3-6');
const carta18 = document.querySelector('.carta-4-1');
const carta19 = document.querySelector('.carta-4-2');
const carta20 = document.querySelector('.carta-4-3');
const carta21 = document.querySelector('.carta-4-4');
const carta22 = document.querySelector('.carta-4-5');
const carta23 = document.querySelector('.carta-4-6');
...
const baraja = [carta0, carta1, carta2, carta3, carta4, carta5, carta6, carta7, carta8, carta9, carta10, carta11, carta12, carta13, carta14, carta15, carta16, carta17, carta18, carta19, carta20, carta21, carta22, carta23];

//Creamos un array auxiliar que nos servirá para almacenar la primera carta que cliquemos y compararla con la segunda. Siempre lo vaciamos para que sólo tenga un elemento. Con el boolean 'esperandoPar' comprobamos qué instrucción es la que toca en función de si hay o no una carta en el array auxiliar a la espera de compararse con el par escogido:
...
function clicarCarta(e) {
    ...
    if (esperandoPar) {
        if (cartaClicada.childNodes[0].textContent === arrayAuxiliar[0].childNodes[0].textContent) {
            ...
            console.log('Error');
            errores++;
            console.log(`Llevas ${errores} errores.`);
...
carta16.addEventListener('click',clicarCarta);
...
carta20.addEventListener('click',clicarCarta);
carta21.addEventListener('click',clicarCarta);
carta22.addEventListener('click',clicarCarta);
carta23.addEventListener('click',clicarCarta);
}, 10000);

//Por último, implementamos los bucles que iniciarán la partida con el efecto secuencial. Cada elemento carta es un <div> al que le añadimos un <p> que llevará como contenido de texto la imagen de fruta correspondiente del 'arrayFrutas'. Lo que hace el segundo bucle es volver a la clase css inicial de cada carta y ocultar la imagen del párrafo para que parezca que "se vuelven a girar las cartas":

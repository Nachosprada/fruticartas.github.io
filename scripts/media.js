...
const carta5 = document.querySelector('.carta-2-1');
const carta6 = document.querySelector('.carta-2-2');
const carta7 = document.querySelector('.carta-2-3');
const carta8 = document.querySelector('.carta-2-4');
const carta9 = document.querySelector('.carta-2-5');
const carta10 = document.querySelector('.carta-3-1');
const carta11 = document.querySelector('.carta-3-2');
const carta12 = document.querySelector('.carta-3-3');
const carta13 = document.querySelector('.carta-3-4');
const carta14 = document.querySelector('.carta-3-5');
const carta15 = document.querySelector('.carta-4-1');
const carta16 = document.querySelector('.carta-4-2');
const carta17 = document.querySelector('.carta-4-3');
const carta18 = document.querySelector('.carta-4-4');
const carta19 = document.querySelector('.carta-4-5');
...
const baraja = [carta0, carta1, carta2, carta3, carta4, carta5, carta6, carta7, carta8, carta9, carta10, carta11, carta12, carta13, carta14, carta15, carta16, carta17, carta18, carta19];
